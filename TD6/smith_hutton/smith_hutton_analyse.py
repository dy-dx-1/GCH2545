...
plt.colorbar(fig1, ax=ax[0], label="Concentration adimensionnelle")

fig2 = ax[1].pcolormesh(x,y, c100_reshaped)
plt.colorbar(fig2, ax=ax[1], label="Concentration adimensionnelle")

fig3 = ax[2].pcolormesh(x,y, c1000_reshaped)
plt.colorbar(fig3, ax=ax[2], label="Concentration adimensionnelle")

ax[0].set_title("Profil de concentration pour $Pe=10$")
ax[1].set_title("Profil de concentration pour $Pe=100$")
ax[2].set_title("Profil de concentration pour $Pe=1000$")
ax[0].set_xlabel("Position adimensionnelle")
ax[1].set_xlabel("Position adimensionnelle")
ax[2].set_xlabel("Position adimensionnelle")
ax[0].set_ylabel("Position adimensionnelle")
ax[1].set_ylabel("Position adimensionnelle")
ax[2].set_ylabel("Position adimensionnelle")
...
ax[0].plot(x_p, s_p10, 'g.-', label="Reférence")
ax[0].plot(x, c10_out, 'r.-', label="Théorique")
ax[1].plot(x_p, s_p100, 'g.-', label="Reférence")
ax[1].plot(x, c100_out, 'r.-', label="Théorique")
ax[2].plot(x_p, s_p1000, 'g.-', label="Reférence")
ax[2].plot(x, c1000_out, 'r.-', label="Théorique")

ax[0].set_title("Profil de concentration à $y=0$ pour $Pe=10$")
ax[1].set_title("Profil de concentration $y=0$ pour $Pe=100$")
ax[2].set_title("Profil de concentration $y=0$ pour $Pe=1000$")
ax[0].set_xlabel("Position adimensionnelle")
ax[1].set_xlabel("Position adimensionnelle")
ax[2].set_xlabel("Position adimensionnelle")
ax[0].set_ylabel("Position adimensionnelle")
